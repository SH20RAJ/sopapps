...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: appDetails.summary,
    openGraph: {
      title: appDetails.title,
      description: appDetails.summary,
      images: [
  ...
  return (
    <>
      ...
      <div className="download text-center text-8xl">
        <a href={appDetails.playstoreUrl} target="_" className="bg-blue-500 text-white px-4 py-2 rounded-md">Download</a>
      </div>
